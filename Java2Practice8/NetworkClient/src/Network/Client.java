...
import Control.AuthorizationController;
                ...
                while (true) {
                    ...
                    switch (command.getType()) {
                        case INFO_MESSAGE: {
                            ...
                            Platform.runLater(() -> {
                                controller.addWordOut(controller.getListViewMesseg(), formattedMessage);
                            });
                            break;
                        }
                        case ERROR: {
                            ...
                            Platform.runLater(() -> {
                                controller.addWordOut(controller.getListViewMesseg(), errorMessage);
                            });
                            break;
                        }
                        ...
                        case END: {
                            ...
                            String sender = data.getSender();
                            Platform.runLater(() -> {
                                controller.addWordOut(controller.getListViewMesseg(), sender + " - вышел из чата");
                            });
                            break;
                        }
                        default:
