...
то метод вернет false; Если есть элементы отличные от 1 и 4 то вернуть false. Написать набор тестов для этого метода
...
[ 1 4 4 1 1 4 3 ] -> false
*/
public class MainPractice6TEST {
    ...
    public static Boolean isOneFourTask2 (Integer[] arr){
        ...
        if (!arrList.isEmpty() || !isContains) {return false;}
        else return true;
    }
}
